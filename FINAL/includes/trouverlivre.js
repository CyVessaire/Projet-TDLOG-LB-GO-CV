		...
		if(isbn !==''){
			...
			$.when(getGoogleBook(isbn),getWorldcatBook(isbn)).done(function(data1,data2) {
					...
					var display_book = function(isbn,refname,title,book,display_url){
						...
						<div class="books" id="'+refname+'_'+isbn+'">\n\t
						<div class="couverture">\n\t</div>\n\t
						<div itemscope itemtype="http://schema.org/Book" class="bookdescription">\n\t\t
						<span itemprop="name" class="name">\n\t\t</span>\n\t\t
						<span class="right_2">de <span itemprop="author" class="author">
						</span><br>\nISBN 13 : <span itemprop="isbn" class="isbn"></span>
						<br>\n Éditeur : <span itemprop="publisher" class="publisher"></span>
						, <span itemprop="datePublished" class="datePublished"></span>,
						<span itemprop="numberOfPages" class="numberOfPages"></span>	 pages<br>
						<span itemprop="isPartOf" class="isPartOf"></span>
						<span itemprop="position" class="position"></span>
